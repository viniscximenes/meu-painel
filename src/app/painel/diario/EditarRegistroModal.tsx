...
import { useState, useTransition, useEffect, useId, forwardRef, useRef } from 'react'
import { X, Pencil, Save, AlertTriangle, CheckCircle, Info, ChevronDown, Check } from 'lucide-react'
import { HaloSpinner } from '@/components/HaloSpinner'
import { OPERADORES_DISPLAY } from '@/lib/operadores'
import { TIPOS_REGISTRO, calcularDeficitForaJornada, JORNADA_OBRIGATORIA_SEGUNDOS, type TipoRegistro, type DiarioRegistro } from '@/lib/diario-utils'
  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="editar-registro-title"
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Pencil size={20} style={{ color: '#f4d47c', flexShrink: 0 }} />
            <div>
              <h3
                id="editar-registro-title"
                style={{
        ...
        >
          ...
          <button
            ...
            style={{
              fontFamily: FF_SYNE, fontWeight: 600, fontSize: '12px',
              textTransform: 'uppercase', letterSpacing: '0.05em',
              minWidth: '160px', opacity: saving || sucesso ? 0.9 : 1,
            }}
          >
            {saving ? (
              <HaloSpinner size="sm" />
